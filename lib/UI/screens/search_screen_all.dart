...
class SearchScreenAll extends StatefulWidget {
  const SearchScreenAll({Key? key}) : super(key: key);
  @override
  State<SearchScreenAll> createState() => _SearchScreenAllState();
}

class _SearchScreenAllState extends State<SearchScreenAll> {
                ...
                child: Consumer<TutorProvider>(
                  builder: (context, tutorsList, child) {
                    ...
                    return FutureBuilder(
                      future: tutorsList.getTutors(10),
